...
create table carga_componente (id integer not null, peso double precision, patio_id integer, conteiner_id integer, agenteEmbarque_id integer, agenteDesembarque_id integer, primary key (id));
