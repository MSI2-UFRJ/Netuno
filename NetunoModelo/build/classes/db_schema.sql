...
create table carga_componente (id integer not null auto_increment, altura double, comprimento double, largura double, peso double, agenteDesembarque_id integer, agenteEmbarque_id integer, conteiner_id integer, patio_id integer, primary key (id));
