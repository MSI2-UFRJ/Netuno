...
create table carga_perecivel (id integer not null auto_increment, peso double, conteiner_id integer, agenteEmbarque_id integer, agenteDesembarque_id integer, patio_id integer, contrato_id integer, data_validade datetime, primary key (id));
