...
create table agenteCarga (id integer not null auto_increment, login varchar(255), senha varchar(255), primary key (id));
create table agentePorto (id integer not null auto_increment, login varchar(255), senha varchar(255), pertence_id integer, primary key (id));
create table agenteRota (id integer not null auto_increment, login varchar(255), senha varchar(255), primary key (id));
...
create table contratante (id integer not null auto_increment, login varchar(255), senha varchar(255), primary key (id));
...
create table represemptrans (id integer not null auto_increment, login varchar(255), senha varchar(255), representa_id integer, empresatransporte_id integer, primary key (id));
