...
create table agenteLogistica (id integer not null, login varchar(255), senha varchar(255), primary key (id));
...
create table carga (id integer not null, peso double precision, agenteEmbarque_id integer, agenteDesembarque_id integer, patio_id integer, conteiner_id integer, contrato_id integer, primary key (id));
...
create table partecarga (id integer not null, peso double precision, agenteEmbarque_id integer, agenteDesembarque_id integer, patio_id integer, conteiner_id integer, carga_id integer, primary key (id));
...
create table represemptrans (id integer not null, login varchar(255), senha varchar(255), representa_id integer, primary key (id));
